...
public class AuthorDaoImpl implements AuthorDao {
    ...
    public Author searchBook(int id) {
        try {
            Session session = software.ujithamigara.OneToMany.util.FactoryConfiguration.getInstance().getSession();
            Transaction transaction = session.beginTransaction();
    ...
    public boolean updateBook(Author author) {
        try {
            Session session = software.ujithamigara.OneToOne.util.FactoryConfiguration.getInstance().getSession();
            Transaction transaction = session.beginTransaction();
